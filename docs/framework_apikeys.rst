...
Edu has a central API key storage utilising the core bots config. This allows cog creators to add a single location to store API keys for their cogs which may be shared between other cogs.
...
.. automethod:: Edu.get_shared_api_tokens

.. automethod:: Edu.set_shared_api_tokens

.. automethod:: Edu.remove_shared_api_tokens

.. automethod:: Edu.remove_shared_api_services

...
.. important::
  ...
  RPC support is included in Edu on a provisional basis. Backwards incompatible changes (up to and including removal of the RPC) may occur if deemed necessary.
...
Please see the :class:`redbot.core.bot.EduBase` class for details on the RPC handler register and unregister methods.

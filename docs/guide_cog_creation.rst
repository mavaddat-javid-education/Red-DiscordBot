...
========================
Creating cogs for Edu V3
========================

This guide serves as a tutorial on creating cogs for Edu V3.
...
Next, you need to decide if you want to develop against the Stable or Develop version of Edu.
...
.. attention::
    ...
    If your goal is to support both versions, make sure you build compatibility layers or use separate branches to keep compatibility until the next Edu release

Open a terminal or command prompt and type one of the following
    Stable Version: :code:`python3.8 -m pip install -U Edu-DiscordBot`

.. note::

  To install the development version, replace ``Edu-DiscordBot`` in the above commands with the
  ...
  .. code-block:: none
      ...
      git+https://github.com/mavaddat-javid-education/Edu-DiscordBot@V3/develop#egg=Edu-DiscordBot
...
.. attention:: 
    While you can intentionally override Edu's cogs/extensions, this may break things.
    ...
    Subclassing to make changes to Edu's cogs/extensions
...
and provide the requested information. Once that's done, run Edu
by doing :code:`redbot <instance name> --dev` to start Edu.
...
:doc:`/guide_cog_creators` explains the Cog Creator Application process and lists requirements and good practices for Cog Creators.  This information is worth following for anyone creating cogs for Edu, regardless of if you plan to publish your cogs or not.

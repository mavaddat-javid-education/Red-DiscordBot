...
Publishing cogs for Edu V3
==========================

Users of Edu install 3rd-party cogs using Downloader cog. To make your cog available
...
our Downloader system and provide essential information to the Edu portal.
...
- ``min_bot_version`` (string) - Min version number of Edu in the format ``MAJOR.MINOR.MICRO``

- ``max_bot_version`` (string) - Max version number of Edu in the format ``MAJOR.MINOR.MICRO``,
...
To be added to the index, make a pull request to the `Edu-Index repository <https://github.com/Cog-Creators/Edu-Index>`_ in the unapproved section. You can learn more about this process in the repository description.

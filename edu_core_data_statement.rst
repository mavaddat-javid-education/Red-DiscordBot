.. Edu Core Data Statement

=====================
Edu and End User Data
=====================

Notes for everyone
******************

What data Edu collects
----------------------

Edu and the cogs included with it collect some amount of data
...
By default, Edu will not collect any more data than it needs, and will not use it
for anything other than the portion of the Edu's functionality that necessitated it.

3rd party extensions may store additional data beyond what Edu does by default.
You can use the command ``[p]mydata 3rdparty``
to view statements about how extensions use your data made by the authors of 
the specific 3rd party extensions an instance of Edu has installed.

How can I delete data Edu has about me?
---------------------------------------
...
3rd party extensions to Edu are able to delete data when this command

...
import discord
from edubot.core import commands, i18n, checks
from edubot.core.utils.common_filters import (
    filter_invites,
    ...
    async def userinfo(self, ctx, *, member: discord.Member = None):
        ...
        if roles:
            ...
            if len(role_str) > 1024:
                ...
                # infinitesimally small compared to when we don't across all uses of Edu.

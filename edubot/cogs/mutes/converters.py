...
# the following regex is slightly modified from Edu
...
# https://github.com/mavaddat-javid-education/Edu-DiscordBot/blob/V3/develop/edubot/core/commands/converter.py#L55

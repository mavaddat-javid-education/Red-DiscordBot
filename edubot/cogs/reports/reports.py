...
from edubot.core import Config, checks, commands
from edubot.core.utils import AsyncIter
from edubot.core.utils.chat_formatting import pagify, box
from edubot.core.utils.antispam import AntiSpam
from edubot.core.bot import Edu
from edubot.core.i18n import Translator, cog_i18n, set_contextual_locales_from_guild
from edubot.core.utils.predicates import MessagePredicate
from edubot.core.utils.tunnel import Tunnel
...
class Reports(commands.Cog):
    ...
    # see edubot/core/utils/antispam.py for more details
    ...
    async def internal_filter(self, m: discord.Member, mod=False, perms=None):
        ...
        # in Edu, though I'm not sure it makes sense to use here.

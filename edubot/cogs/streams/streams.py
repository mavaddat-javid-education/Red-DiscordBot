...
from edubot.core import checks, commands, Config
from edubot.core.i18n import cog_i18n, Translator, set_contextual_locales_from_guild
from edubot.core.utils._internal_utils import send_to_owners_with_prefix_replaced
from edubot.core.utils.chat_formatting import escape, pagify
...
class Streams(commands.Cog):
    ...
    async def twitchtoken(self, ctx: commands.Context):
        ...
        message = _(
            ...
            "3. Enter a name, set the OAuth Eduirect URI to `http://localhost`, and "

...
from edubot.core.utils import AsyncIteredubot
...
async def bank_prune(bot: Edu, guild: discord.Guild = None, user_id: int = None) -> None:
...
def cost(amount: int):
    ...
    Other exceptions will propagate and will be handled by Edu's (and/or

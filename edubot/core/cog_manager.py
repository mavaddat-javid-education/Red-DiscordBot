...
import edubot.cogsedubot
from edubot.core.utils import deduplicate_iterables
import discord
...
class CogManager:
    """Directory manager for Edu's cogs.
    ...
    CORE_PATH = Path(edubot.cogs.__path__[0])
...
class CogManagerUI(commands.Cog):
    """Commands to interface with Edu's cog manager."""

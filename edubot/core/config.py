...
class Value:
    ...
    driver : `edubot.core.drivers.BaseDriver`
...
class Config(metaclass=ConfigMeta):
    """Configuration manager for cogs and Edu.
    ...
    unique_identifier : `int`
        ...
        conflicts occur.
    driver
        An instance of a driver that implements `edubot.core.drivers.BaseDriver`.
    force_registration : `bool`
    ...
    def guild_from_id(self, guild_id: int) -> Group:
        ...
        Returns
        -------
        `Group <edubot.core.config.Group>`

...
def create_temp_config():
    """
    Creates a default instance for Edu, so it can be ran
...
def load_basic_configuration(instance_name_: str):
    ...
    try:
        ...
        print(
            "You need to configure the bot instance using `edubot-setup`"
    ...
    try:
        ...
        print(
            ...
            " You can create new instance using `edubot-setup` prior to running the bot."
        )
        sys.exit(1)

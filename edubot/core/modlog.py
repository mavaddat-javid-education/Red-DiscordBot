...
class Case:
    ...
    @classmethod
    async def from_json(
        cls, mod_channel: discord.TextChannel, bot: Edu, case_number: int, data: dict, **kwargs
    ):
...
async def get_case(case_number: int, guild: discord.Guild, bot: Edu) -> Case:
    """
...
async def get_latest_case(guild: discord.Guild, bot: Edu) -> Optional[Case]:
...
async def get_all_cases(guild: discord.Guild, bot: Edu) -> List[Case]:
    """
...
async def get_cases_for_member(
    guild: discord.Guild, bot: Edu, *, member: discord.Member = None, member_id: int = None
) -> List[Case]:
    """
...
async def register_casetypes(new_types: List[dict]) -> List[CaseType]:
    ...
    See Also
    --------
    edubot.core.modlog.register_casetype

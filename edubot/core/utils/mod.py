...
async def is_allowed_by_hierarchy(
    bot: "Edu", settings: "Config", guild: discord.Guild, mod: discord.Member, user: discord.Member
):
    warnings.warn(
        "`is_allowed_by_hierarchy()` is deprecated since Edu 3.4.1"
...
async def is_mod_or_superior(
    bot: "Edu", obj: Union[discord.Message, discord.Member, discord.Role]
):

...
class EduRichHandler(RichHandler):
    ...
    def emit(self, record: LogRecord) -> None:
        ...
        if self.rich_tracebacks and record.exc_info and record.exc_info != (None, None, None):
            ...
            traceback = EduTraceback.from_exception(
                exc_type,
                exc_value,
                exc_traceback,

...
from edubot import _early_init
...
from edubot.core.cli import confirmedubotedubotedubotedubot
from edubot.core.utils._internal_utils import safe_delete, create_backup as red_create_backup
from edubot.core import config, data_manager, drivers
from edubot.core.drivers import BackendType, IdentifierData

conversion_log = logging.getLogger("red.converter")

config_dir = None
appdir = appdirs.AppDirs("Edu-DiscordBot")
...
def basic_setup():
    ...
    print()
    print(
        "Your basic configuration has been saved. Please run `edubot <name>` to"
...
async def create_backup(instance: str, destination_folder: Path = Path.home()) -> None:
    ...
    backup_fpath = await edu_create_backup(destination_folder)
